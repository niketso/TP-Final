...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("Nicolas Piccitto", "TP-Final", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "TP-Final";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "TP-Final", null, { width: 640, height: 480 });
